...
$(document).ready(function () {
    ...
    tableData = $("#tbData").DataTable({
        ...
        "columns": [
            ...
            {
                "defaultContent":
                    '<button class="btn btn-primary btn-edit btn-sm mr-2"><i class="fa-solid fa-pen-to-square"></i></button>' +   
                    '<button class="btn btn-danger btn-delete btn-sm"><i class="fa-solid fa-trash-can"></i></button>',
...
const openModal = (model = BASIC_MODEL ) => {
    ...
    $("#imgUser").attr("src", "https://cdn-icons-png.flaticon.com/512/149/149071.png");
    else
